...
edge_image_file = args.edge_image_file # this is the train_data_91k.mat
...
# currently n c h w 
# needs to be in h w c n
pivot_images = data['pivot_images']
# pivot_images = np.transpose(pivot_images, (2, 3, 1, 0))
...
sio.savemat(save_file, {'features':features, 'cameras':cameras})
