...
try:
    ...
    data = hdf5storage.loadmat(train_file)
...
# Statistics of the camera in the training data. For example, its mean location and standard deviation. These information are used to sample simulated camera views.
# https://github.com/lood339/SCCvSD/issues/17
normalize = transforms.Normalize(mean=[0.0188],
                                 std=[0.128])
