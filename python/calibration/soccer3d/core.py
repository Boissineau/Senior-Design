...
class YoutubeVideo:
    ...
    def __init__(self, path_to_dataset):
        ...
        self.frame_basenames.sort(key=sortkey_natural)
        self.frame_fullnames.sort(key=sortkey_natural)
        ...
        if exists(calib_file):
            ...
            if not self.file_lists_match(listdir(join(self.path_to_dataset, 'calib'))):
                ...
                if exists(manual_calib):
                    ...
                    A, R, T = calibration.calibrate_by_click(img)
                ...
                if A is None:
                    ...
                    for i in tqdm(range(1, self.n_frames)):
                        ...
                        if i % vis_every == 0:
                            ...
                            vis = False
                        A, R, T, __ = calibration.calibrate_from_initialization(img, A, R, T, vis)
