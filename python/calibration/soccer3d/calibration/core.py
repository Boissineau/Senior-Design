...
def calibrate_by_click(img, edge_sfactor=0.5, field_img_path='./data/field.png'):
    ...
    A__, R__, T__, field3d = calibrate_from_initialization(img, A, R, T, edge_sfactor)
...
def calibrate_from_initialization(img, A_init, R_init, T_init, edge_sfactor=0.5, visualize=False):
